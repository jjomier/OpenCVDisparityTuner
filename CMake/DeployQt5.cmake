...
function(install_qt5_dbdrivers dest)
    install_qt5_file(${_qt5Core_install_prefix}/plugins/sqldrivers "qsqlite" ${dest}/sqldrivers)
...
function(install_qt5_icu dest)
    file( GLOB ICU_DLL ${_qt5Core_install_prefix}/bin/icu*.dll )
    install(FILES ${ICU_DLL}
            DESTINATION ${dest})
